import { Address, states } from 'gif-cube-shared';
    ...
    render() {
        return (
            <div className='address-form'>
                <LabeledInput id='first-name'
                    label='First Name'
                    autoComplete='given-name'
                    value={this.props.address.firstName}
                    onChange={newName => this.updateAddress(this.props.address.withFirstName(newName))} />

                <LabeledInput id='last-name'
                    label='Last Name'
                    autoComplete='family-name'
                    value={this.props.address.lastName}
                    onChange={newName => this.updateAddress(this.props.address.withLastName(newName))} />
