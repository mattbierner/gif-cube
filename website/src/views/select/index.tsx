...
export class SelectView extends React.Component<SelectViewProps, SelectViewState> {
    ...
    private onGifSelected(src: string) {
        ...
        loadGif(src)
            .then(gif => {
                ...
                if (this.hasValidAspectRatio(gif)) {
                    this.setState({
                        error: 'The aspect ratio of your gif is too high. Please select a more square gif'
                    })
                    return;
                }
    ...
    private hasValidAspectRatio(gif: Gif) {
        return gif.width / gif.height < config.minAspectRatio || gif.height / gif.width < config.minAspectRatio;
    }
